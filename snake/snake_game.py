...
#Background Image
bgimg = pygame.image.load("snake/Snake1.jpg")
...
def gameloop():
    ...
    if(not os.path.exists("snake/hiscore.txt")):
        with open("snake/hiscore.txt", "w") as f:
            f.write("0")

    with open("snake/hiscore.txt", "r") as f:
        hiscore = f.read()
    ...
    while not exit_game:
        if game_over:
            ...
            if head in snk_list[:-1]:
                game_over = True
                pygame.mixer.music.load('snake/gameover.mp3')
